...
const EVENT_TYPES = [
  ...
  'news', 'alert', 'climate', 'anomaly', 'waterlogging', 'exposure', 'flood', 'rain_forecast', 'route', 'transit',
];
...
const LAYERS = [
  ...
  'flood_forecast', 'rain_forecast', 'transit', 'access_routes',
];
...
const DEFAULT_LAYER = {
  ...
  exposure: 'exposure',
  flood: 'flood_forecast',
  rain_forecast: 'rain_forecast',
  route: 'access_routes',
  transit: 'transit',
};
const DEFAULT_TAG = {
  news: 'MEDIA_REPORTED', climate: 'REAL_STATIC', anomaly: 'REAL_STATIC', waterlogging: 'MEDIA_REPORTED', exposure: 'REAL_STATIC',
  route: 'REAL_STATIC', transit: 'REAL_STATIC',
  // Both are real model output (GloFAS / Open-Meteo forecast), not measured - ESTIMATED,
  // never REAL_LIVE, so the honesty tag itself signals "forecast" before anyone reads raw.
  flood: 'ESTIMATED', rain_forecast: 'ESTIMATED',
};
