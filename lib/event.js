...
const EVENT_TYPES = ['earthquake', 'weather', 'air_quality', 'traffic', 'crowd', 'civic', 'event'];
 ...
 */
function makeEvent({ id, type, title, lat, lng, timestamp, severity, source, isSimulated = false, raw = {} }) {
  const event = {
    id: String(id),
    type,
    title,
...
module.exports = { EVENT_TYPES, validateEvent, makeEvent };
