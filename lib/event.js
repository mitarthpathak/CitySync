...
const LAYERS = ['earthquakes', 'weather', 'air_quality', 'news', 'alerts', 'climate', 'anomaly', 'simulated'];
...
const DEFAULT_TAG = { news: 'MEDIA_REPORTED', climate: 'REAL_STATIC', anomaly: 'REAL_STATIC' };
 ...
 */
function makeEvent({
  id, type, title, lat, lng, timestamp, severity, source, isSimulated = false, raw = {}, layer, tag, sourceUrl,
}) {
